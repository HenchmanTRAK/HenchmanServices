...
class NETWORKMANAGER_EXPORT NetworkManager : public QObject
{
	Q_OBJECT
...
public:
	...
	*/
	...
	int makeOptionsRequest(const QString& url, const QJsonObject& queryMap, QJsonDocument* results = nullptr);
	...
	int makePatchRequest(const QString& url, const QJsonObject& queryMap, const QJsonObject& body, QJsonDocument* results = nullptr);
