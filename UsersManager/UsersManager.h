...
namespace UsersManager {
	...
	class CUsersManager : public TRAKEntriesManager::CTRAKEntriesManager
	{
		Q_OBJECT

	public:
		using TRAKEntriesManager::CTRAKEntriesManager::CTRAKEntriesManager;
		explicit CUsersManager(QObject* parent = nullptr, const TrakDetails& trakDetails = TrakDetails(), const WebportalDetails& webportalDetails = WebportalDetails(), const s_DATABASE_INFO& database_info = s_DATABASE_INFO());
...
// Q_DECLARE_METATYPE(UsersManager::CUsersManager);
